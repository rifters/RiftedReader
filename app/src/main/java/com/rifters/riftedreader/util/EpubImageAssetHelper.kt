...
object EpubImageAssetHelper {
     ...
     * 
     * Used as a fallback for missing images to avoid broken image icons in WebView.
     * This is shared between EpubImagePathHandler and other resource interceptors.
     * 
     ...
     */
    val TRANSPARENT_PNG_BYTES: ByteArray = byteArrayOf(
